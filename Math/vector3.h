...
public:
	...
	// return new vector trat is the cross product of 'this' and rhs
	//
	...
	// Returns a new vector by normalizing 'this'
	//
	// Note: If this is zero vector, return UNIT_Z vector.
	Vector3 normalize() const;

	// Returns a new vector by normalizing 'this' using L1 (so that the coordinates sum to one)
	//
	// Note: If this is zero vector, return ZERO vector.
