...
void ShaderProgram::initDefaultUniforms() {
	...
	// @@ TODO: Create uniform variables for different textures: bump mapping, cube mapping, etc.
...
void ShaderProgram::beforeDraw() {
	...
	if (mat != 0) {
		...
		// @@ TODO: Initialize uniform variables for different textures: bump mapping, cube mapping, etc.
